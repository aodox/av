...
|---------|-----|------------|------|
| ✅ 推流回调 | `http://YOUR_IP:8080/v1/callback/event` | 1 | 开始推流 |
| ✅ 断流回调 | `http://YOUR_IP:8080/v1/callback/event` | 0 | 断开推流 |
| ✅ 录制文件回调 | `http://YOUR_IP:8080/v1/callback/event` | 100 | 录制完成 |
| ✅ 截图回调 | `http://YOUR_IP:8080/v1/callback/event` | 200 | 截图完成 |
| ✅ 录制状态回调 | `http://YOUR_IP:8080/v1/callback/event` | 332 | 录制状态变化 |
| ✅ 图片审核回调 | `http://YOUR_IP:8080/v1/callback/event` | 317 | 鉴黄结果 |
| ✅ 音频审核回调 | `http://YOUR_IP:8080/v1/callback/event` | 318 | 音频审核 |

**异常事件回调**：

| 回调类型 | URL | event_type | 说明 |
|---------|-----|------------|------|
| ✅ 推流异常回调 | `http://YOUR_IP:8080/v1/callback/event` | 321 | 推流异常 |
| ✅ 录制异常回调 | `http://YOUR_IP:8080/v1/callback/event` | 341 | 录制异常 |
